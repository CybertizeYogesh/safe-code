...
export const metadata = {
  title: "About Us | Indian Best Packers & Movers",
  description: "Learn more about Indian Best Packers & Movers, our 16 years of experience, and our mission to provide secure, timely, and affordable relocation services.",
  alternates: {
    canonical: "https://www.indianbestpackersmovers.com/about.html",
  },
};
...
export default function About() {
  const schemaJson = {
    ...
    "@type": "AboutPage",
    "name": "About Indian Best Packers & Movers",
    "description": "Learn more about Indian Best Packers & Movers, our 16 years of experience, and our mission to provide secure, timely, and affordable relocation services.",
    "publisher": {
      "@type": "Organization",
                ...
                <div className="img-box1">
                  <div className="shape1 jump">
                    <img
                      ...
                      alt="Indian Best Packers and Movers Jaipur Loading Operations"
                      width="270"
                      height="380"
                      loading="lazy"
                    />
                  ...
                  <div className="img2">
                    <img
                      ...
                      alt="Indian Best Packers and Movers Jaipur Shifting Team"
                      width="400"
                      height="500"
                      loading="lazy"
                    />
            ...
            <div className="col-xl-6">
              <div className="title-area">
                ...
                <p className="sec-text">
                  ...
                  your valuables. Indian Best Packers & Movers can be helpful in completing relocation of all your valuables
                  in your destination.
                </p>
              </div>
